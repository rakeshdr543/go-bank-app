...
var file_proto_rpc_login_user_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01,
	...
	0x2f, 0x72, 0x61, 0x6b, 0x65, 0x73, 0x68, 0x64, 0x72, 0x35, 0x34, 0x33, 0x2f, 0x73, 0x61, 0x6d,
...
var file_proto_rpc_login_user_proto_goTypes = []interface{}{
...
func file_proto_rpc_login_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_rpc_login_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_rpc_login_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
